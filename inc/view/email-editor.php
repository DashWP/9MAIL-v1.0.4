        ...
        <div id="emtmpl-control-panel">
            <div class="emtmpl-control-panel-fixed">
                <div class="vi-ui three item stackable tabs menu">
                    <a class="active item" data-tab="components"><?php esc_html_e( 'Components', '9mail-wordpress-email-templates-designer' ); ?></a>
                    <a class="item" data-tab="editor"><?php esc_html_e( 'Editor', '9mail-wordpress-email-templates-designer' ); ?></a>
                    <a class="item" data-tab="custom_css"><?php esc_html_e( 'Custom CSS', '9mail-wordpress-email-templates-designer' ); ?></a>
                </div>
                <div class="emtmpl-scroll">
                    <div class="vi-ui bottom attached active tab" data-tab="components">
                        <div id="emtmpl-element-search">
                            <i class="dashicons dashicons-search"></i>
                            <input type="text" class="emtmpl-search" placeholder="<?php esc_attr_e( 'Search element', '9mail-wordpress-email-templates-designer' ); ?>">
                        </div>
                ...
                <div id="emtmpl-main-actions">
                    <div class="emtmpl-main-actions-inner">
                        <div class="emtmpl-actions-front">
                            ...
                            <a class="emtmpl-exit-to-dashboard " href="<?php echo esc_url( admin_url( 'edit.php?post_type=emtmpl' ) ) ?>">
                                <i class="dashicons dashicons-arrow-left"
                                   title="<?php esc_attr_e( 'Exit to DashBoard', '9mail-wordpress-email-templates-designer' ); ?>">
                                </i>
                            </a>

                            <i class="dashicons dashicons-arrow-<?php echo esc_attr( $arrow ) ?> emtmpl-toggle-admin-bar"
                               title="<?php esc_attr_e( 'Toggle admin menu', '9mail-wordpress-email-templates-designer' ) ?>">
                            </i>

                            <a class="emtmpl-add-new" href="<?php echo esc_url( admin_url( "post-new.php?post_type={$post->post_type}" ) ) ?>">
                                <i class="dashicons dashicons-plus" title="<?php esc_attr_e( 'Add new', '9mail-wordpress-email-templates-designer' ); ?>">
                                </i>
                            </a>
                            <a class="emtmpl-duplicate-post"
                               href="<?php echo esc_url( admin_url( 'post.php?action=emtmpl_duplicate&id=' ) . get_the_ID() ) ?>">
                                <i class="dashicons dashicons-admin-page"
                                   title="<?php esc_attr_e( 'Copy to draft', '9mail-wordpress-email-templates-designer' ); ?>">
                                </i>
							...
							if ( current_user_can( 'delete_post', $post->ID ) ) {
								echo sprintf( "<a class='emtmpl-trash-post' href='%1s' title='%2s'><i class='dashicons dashicons-trash'> </i></a>",
									esc_attr( get_delete_post_link( $post->ID ) ), esc_attr__( 'Move to trash', '9mail-wordpress-email-templates-designer' ) );
							}
							?>
    ...
    <div id="emtmpl-email-editor-wrapper" style="background-size: cover;background-position: center top; background-repeat: no-repeat;">
        <div class="emtmpl-edit-bgcolor-btn">
            <span class="vi-ui button mini">
                ...
                <span><?php esc_html_e( 'Background', '9mail-wordpress-email-templates-designer' ); ?></span>
            </span>
        </div>
        ...
        <div id="emtmpl-quick-add-layout">
            <div class="dashicons dashicons-plus emtmpl-quick-add-layout-btn"
                 title="<?php esc_attr_e( 'Select layout', '9mail-wordpress-email-templates-designer' ); ?>"></div>
...
<div id="emtmpl-templates">
                ...
                <div class="emtmpl-flex emtmpl-layout-inner" data-type="{%=type%}">
                    ...
                    <div class="emtmpl-column emtmpl-column-placeholder" style="width:{%=width%};">
                        ...
                        <div class="emtmpl-column-control">
                            <span class="emtmpl-column-paste" title="<?php esc_attr_e( 'Paste', '9mail-wordpress-email-templates-designer' ); ?>">
                                <i class="dashicons dashicons-arrow-down-alt"></i>
                            </span>
                            <span class="emtmpl-column-edit" title="<?php esc_attr_e( 'Edit column', '9mail-wordpress-email-templates-designer' ); ?>">
                                <i class="dashicons dashicons-edit"></i>
                            </span>
                        </div>
    ...
    <script id="emtmpl-input-texteditorinput" type="text/html">
        <div>
            <textarea name="{%=key%}" class="form-control" id="emtmpl-text-editor" rows="7"></textarea>
        </div>
    </script>
    ...
    <script id="emtmpl-input-colorinput" type="text/html">
        <div>
            ...
            <span class="emtmpl-clear dashicons dashicons-no-alt" title="<?php esc_attr_e( 'Clear', '9mail-wordpress-email-templates-designer' ); ?>"></span>
        </div>
    </script>
    ...
    <script id="emtmpl-recover-email-content" type="text/html">
        <p><?php esc_html_e( "Email content is displayed here. You can modify the attributes in paragraph section.", '9mail-wordpress-email-templates-designer' ); ?></p>
        <br/>
        <p><?php esc_html_e( "If ignore this template for an email, let's add this shortcode {{ignore_9mail}} to that email content.", '9mail-wordpress-email-templates-designer' ); ?></p>
        <br/>
        <p><?php esc_html_e( "You can modify some attributes for the links in email in the Link section:", '9mail-wordpress-email-templates-designer' ); ?></p>
    ...
    <script id="emtmpl-recover-email-heading" type="text/html">
        <div>
			<?php esc_html_e( 'Thank you for your order', '9mail-wordpress-email-templates-designer' ); ?>
            <span class="emtmpl-note"><?php esc_html_e( 'The heading of original email will be transferred here', '9mail-wordpress-email-templates-designer' ); ?></span>
        </div>
    </script>
